			...
			<form action="" id="manage-lesson">
                ...
                <div class="form-group">
					<label for="" class="control-label">Questions</label>
					 <textarea name="question" id="" cols="30" rows="10" class="form-control summernote"><?php echo isset($question) ? $question : ""; ?></textarea>
				</div>
				 <div class="form-group">
		 ...
		 $('#manage-lesson').submit(function(e){
		 	...
		 	$.ajax({
				...
				success:function(resp){
					if(resp>0){
						location.href = "./?page=homework/view_assignment&id="+resp;
					}else{
						alert_toast('Assignment submitted successfully');
						end_loader();
					}
				}
			})
