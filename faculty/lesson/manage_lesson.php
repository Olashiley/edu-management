...
<!--
				<div class="form-group">
                    <label for="" class="control-label">Upload Lesson Files (PDF, DOCX)</label>
                        <input type="file" class="form-control" name="lesson_file[]" multiple accept=".pdf, .docx" >
                </div>
-->
                
                <div class="form-group">
                    <label for="" class="control-label">Upload Lesson Files (PDF, DOCX, Videos)</label>
                    <input type="file" class="form-control" name="lesson_file[]" multiple accept=".pdf, .docx, .mp4, .mov, .avi">
                </div>
			</form>
		</div>
	</div>
		 	...
		 	$.ajax({
				...
				success:function(resp){
					if(resp>0){
						...
						alert_toast('Lesson submitted successfully');
						end_loader();
					}
				}
			})
