...
<div class="container-fluid">
					...
					<a href="<?php echo base_url.'admin' ?>" class="portal-link">
						<div class="card card-widget widget-user">
			              ...
			              <div class="widget-user-header bg-info">
			                <h3 class="widget-user-username"><b>Admin</b></h3>
			              </div>
			              ...
			              <div class="card-footer bg-info">
			                <div class="container">
			                	<p class="text-center text-white-50"><small><b>Click here Admin</b></small></p>
			                </div>
			              </div>
			            </div>
					</a>
				...
				<div class="col-md-4">
					<a href="<?php echo base_url.'faculty' ?>" class="portal-link">
						<div class="card card-widget widget-user">
			              <!-- Add the bg color to the header using any of the bg-* classes -->
			              <div class="widget-user-header bg-info">
			                <h3 class="widget-user-username"><b>Facilitator</b></h3>
			              </div>
			              <div class="widget-user-image">
			              ...
			              <div class="card-footer bg-info">
			                <div class="container">
			                	<p class="text-center text-white-50"><small><b>Click here Facilitator</b></small></p>
			                </div>
			              </div>
			            </div>
					</a>
					...
					<a href="<?php echo base_url.'student' ?>" class="portal-link">
						<div class="card card-widget widget-user">
			              ...
			              <div class="card-footer bg-info border-info">
			                <div class="container">
			                	<p class="text-center text-white-50"><small><b>Click here to Signin or Register</b></small></p>
			                </div>
			              </div>
			            </div>
					</a>
	...
	<section>
		<div class="col-lg-12">
            <h1 class="text-center"><font color= "green">Welcome</font></h1>
